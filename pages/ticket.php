...
<div class="leftside">
    ...
    <div class="page-header margin-top-10">
        <h4>Mes tickets</h4>
                ...
                <div class="wheel" id="wheel">
                    ...
                    echo '<p>'. $translations["MOTS_203"] .' <span class="' . $statusClass . '">' . $ticketStatus . '</span></p>';
                    echo '<p>'. $translations["MOTS_204"] .' ' . date('d-m-y H:i:s', strtotime($ticketDetails['date'])) . '</p>';
					...
					if ($ticketStatus === 'Résolu') {
                        echo $translations["ALERTES_042"];
					} else {
						?>
						<!-- Afficher le formulaire de réponse -->
						<form action="?page=ticket_reply" method="post" onsubmit="return validateForm()">
    ...
    <div style="text-align: right;">
        <a href="?page=support"><?php echo $translations["MOTS_205"]; ?></a>
    </div>
</div>